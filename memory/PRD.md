...
- "The Living Spirit of Vrindavan" section (#vrindavan-roots): looping incense-burning video (local /videos/incense-vrindavan.mp4 with poster fallback — headless test Chromium lacks H.264, plays in real browsers), 2 poetic paragraphs, and a gallery of REAL Vrindavan photos hosted locally (Keshi Ghat, Radha Raman Temple, Prem Mandir, 1860s temple gate from Wikimedia Commons, + user's Govardhan forest photo, rose shringar, evening darshan, sacred kund — 8 images total) — all translated into 7 languages
